            ...
            <div className="flex-1 w-full md:w-2/3">
              ...
              <div className="flex items-center cursor-pointer mb-2 md:mb-0">
                {companyData && companyData?.imgUrl ? (
                  ...
                  <>
                    <Image                       src="/assets/images/user_profile.png"
                      className="w-10 h-10 mr-3 rounded-full"
                      width={25}
                      height={25}
                      alt="Company Logo"
              ...
              <div className="flex flex-col-reverse md:flex md:flex-row md:space-x-5">
                {image ? (
                  ...
                  <Image                     src="/assets/images/giveaway_img.png"
                    className="w-full md:max-w-[192px] py-5 rounded-sm"
                    width={192}
                    height={192}
                    alt="Giveaeway featured image"
              ...
              <div className="flex justify-between">
                <h3 className="flex text-xl font-medium items-center space-x-4 mt-10 mb-4">
                  <Image                     src="/assets/images/gift_icon_white.svg"
                    width={24}
                    height={24}
                    alt="Giveaeway featured image"
                  />{" "}
              ...
              <div className="group">
                <h3 className="flex text-xl font-medium items-center space-x-4 mt-10 mb-4">
                  <Image                     src="/assets/images/bell_icon.svg"
                    className=""
                    width={24}
                    height={24}
                    alt="Giveaeway featured image"
              ...
              <div className="group">
                <h3 className="flex text-xl font-medium items-center space-x-4 mt-10 mb-4">
                  <Image                     src="/assets/images/list_icon.svg"
                    className=""
                    width={24}
                    height={24}
                    alt="Giveaeway featured image"
              ...
              <div className="">
                <h4 className="flex text-base font-medium items-center space-x-4 mt-10 mb-4">
                  <Image                     src="/assets/images/info_icon.svg"
                    className=""
                    width={24}
                    height={24}
                    alt="Giveaeway featured image"
